...
/**
 * 类名: MultipartRequest <p>
 * 创建人: YanJ <p>
 * 创建时间: 2017/9/7 11:20 <p>
 * 描述:
 * <p>
 * 更新人: <p>
 * 更新时间: <p>
...
//            CLog.log(mFileParts.size() + "个，长度：" + l);
            Log.e("aaa", mFileParts.size() + "个，长度：" + l);
        }
    ...
    public String getBodyContentType() {
        System.out.println("aaa contentType:" + entity.getContentType().getValue());
...
//        CLog.log("parseNetworkResponse");
        Log.e("aaa", "parseNetworkResponse");
        if (VolleyLog.DEBUG) {
